...
import { AwardPick, Herd } from "./Route"
import "./recap.css"
...
export default function AwardCard(props:Props) {
            ...
            <div className = "award">
                ...
                <div className = "award-body">
                    <div className = "award-avatar is-logo">
                        <img src = {API.generateLink(h.team.logo)} alt = {h.team.name} />
                    </div>
    ...
    return (
        <a className = "award" href = {`/picks/${p.user.uuid}`}>
            <div className = "award-head">
                <span className = "award-icon">{props.icon}</span>
                <span className = "award-title">{props.title}</span>
            </div>
            <div className = "award-body">
                <div className = "award-avatar">
                    <img src = {API.generateLink(p.user.propic)}
                ...
                <div className = {`award-margin hp-num ${p.margin >= 0? "is-win" : "is-loss"}`}>
                    {signed(p.margin)}
                </div>
            </div>
